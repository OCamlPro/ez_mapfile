...
If :code:`ez_mapfile` is available in your opam repository, you can just call::

  opam install ez_mapfile

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`ez_mapfile` in a directory.
