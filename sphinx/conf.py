...
# -*- coding: utf-8 -*-
#
# ez_mapfile documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ez_mapfile.tex', 'ez_mapfile Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ez_mapfile', 'ez_mapfile Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ez_mapfile', 'ez_mapfile Documentation',
     author, 'ez_mapfile', 'One line description of project.',
     'Miscellaneous'),
]
